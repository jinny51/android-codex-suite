...
description: "Use when an Android change is being implemented under the optional Jinny practices extension and the task needs Jinny naming, helper-organization, or review conventions. Apply these as recommendations without weakening android-change-policy or project rules."
---

# Jinny Android Coding Practices

Apply these conventions only where they fit the existing project. They are additive:
`android-change-policy`, repository instructions, public API compatibility, generated
code ownership, and established local style always take precedence.
