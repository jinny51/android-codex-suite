...
Standalone AKBS member plugin, version 2.2.0. It owns member setup, knowledge
...
`internal/incoming-v2/scripts/akbs_member_intake.py`. Current capture and submit use
